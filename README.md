...
Declare the external dependencies of your Gradle plugin project. The external dependencies have to be defined _before_ the `plugindev` extension in order
to show up properly in the _pom.xml_ that is generated by Gradle.
